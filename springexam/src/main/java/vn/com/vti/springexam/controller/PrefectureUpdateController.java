...
public class PrefectureUpdateController {
	...
	public String init(@RequestParam Integer prefectureId, PrefectureForm prefectureForm, Model model) {
		...
		//select * from Prefecture_Infrastructure where Prefecture_Id = 10 ;
		
		List<PrefectureInfrastructure> prefectureInfrastructureList = prefectureInfrastructureMapper.selectByExample(prefectureInfrastructureExample);
